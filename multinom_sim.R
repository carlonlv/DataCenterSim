...
multinom_sim <- setClass("multinom_sim",
                       ...
                       prototype = list(window_size_for_reg = NA_real_,
                                        ...
                                        probability_expectation = function(prob_dist, quantiles) {
                                          return(find_expectation_state_based_dist(prob_dist, quantiles))
                                        }),
                       contains = "sim",
                       validity = check_valid_multinom_sim)


#' @describeIn train_model Train Markov Model specific to multinom_sim object.
setMethod("train_model",
          signature(object = "multinom_sim", train_x = "matrix", train_xreg = "NULL", trained_model = "list"),
...
setMethod("do_prediction",
          signature(object = "multinom_sim", trained_result = "list", predict_info = "data.frame", test_x = "matrix", test_xreg = "NULL"),
...
#' @describeIn train_model Train Markov Model specific to multinom_sim object.
setMethod("train_model",
          signature(object = "multinom_sim", train_x = "matrix", train_xreg = "matrix", trained_model = "list"),
          function(object, train_x, train_xreg, trained_model) {
...
#' @describeIn do_prediction Do prediction based on trained Markov Model.
setMethod("do_prediction",
          signature(object = "multinom_sim", trained_result = "list", predict_info = "data.frame", test_x = "matrix", test_xreg = "matrix"),
          function(object, trained_result, predict_info, test_x, test_xreg) {
            compute_pi_up <- function(prob, to_states, quantiles=NULL) {
              current_state <- 1
              current_prob <- 0

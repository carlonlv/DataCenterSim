...
setMethod("plot_sim_tracewise",
          signature(object = "var1_sim", index = "numeric", trace_name = "character", trainset = "data.frame", testset = "data.frame", prev_score = "data.frame", last_score = "numeric", decision = "list"),
